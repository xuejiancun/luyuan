					    ...
					    public void onResponse(tbl_whPurchaseOrder response) {
						   ...
						   // purchaseorder = response;
						    if (response.getSuccess().equals("true")) {
							    ...
							    int size=response.gettbl_whPurchaseOrderDetail().size();
							    ...
							    {
								    values[i]=response.gettbl_whPurchaseOrderDetail().get(i)
										    .getitemID();
								    valuesqty[i]=response.gettbl_whPurchaseOrderDetail().get(i)
										    .getExamineQTY();
								    valuesitemcode[i]=response.gettbl_whPurchaseOrderDetail().get(i)
										    .getitemCode();
								    itemValues[i]=response.gettbl_whPurchaseOrderDetail().get(i)
										    .getitemCode()+"|"+response.gettbl_whPurchaseOrderDetail().get(i)
										    .getExamineQTY()+response.gettbl_whPurchaseOrderDetail().get(i)
										    .getInventoryUOM();
							    }
		    ...
		    public void onClick(View view) {
			  ...
			  //  data.setVoucherCode("BGD000537");
			   ...
			   // data.setCreatedOn(sDateFormat.format(new java.util.Date()));
			    ...
			    data.setFinish(result.getText().toString());
