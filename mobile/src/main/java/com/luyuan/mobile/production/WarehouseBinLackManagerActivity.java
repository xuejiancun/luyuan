...
public class WarehouseBinLackManagerActivity extends Activity  {
...
//			    if(wbcode.isEmpty())
//			    {
//				    new AlertDialog.Builder(WarehouseBinLackManagerActivity.this)
...
//			    fragmentTransaction.commit();
			    Intent intent = new Intent(getApplicationContext(),
					    WarehouseBinLackSearchDetailActivity
					    .class);
		...
		pickDate_s.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pickDate_s.equals((Button) v)) {
					msg.what = WarehouseBinLackManagerActivity.SHOW_DATAPICK;
				}
				WarehouseBinLackManagerActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
		...
		pickDate_e.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pickDate_e.equals((Button) v)) {
					msg.what = WarehouseBinLackManagerActivity.SHOW_DATAPICK2;
				}
				WarehouseBinLackManagerActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
		pickTime_s.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pickTime_s.equals((Button) v)) {
					msg.what = WarehouseBinLackManagerActivity.SHOW_TIMEPICK;
				}
				WarehouseBinLackManagerActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
		pickTime_e.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pickTime_e.equals((Button) v)) {
					msg.what = WarehouseBinLackManagerActivity.SHOW_TIMEPICK2;
				}
				WarehouseBinLackManagerActivity.this.dateandtimeHandler.sendMessage(msg);
			}
		});
	...
	Handler dateandtimeHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case WarehouseBinLackManagerActivity.SHOW_DATAPICK:
					showDialog(DATE_DIALOG_ID);
					break;
				case WarehouseBinLackManagerActivity.SHOW_TIMEPICK:
					showDialog(TIME_DIALOG_ID);
					break;
				case WarehouseBinLackManagerActivity.SHOW_DATAPICK2:
					showDialog(DATE_DIALOG_ID2);
					break;
				case WarehouseBinLackManagerActivity.SHOW_TIMEPICK2:
