...
public class WarehouseLocationInventoryActivity extends Activity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(R.string.function_warehouse_locationinventory_search);
    ...
    private void rePlaceTabContentForSearch(String api) {
        WarehouseLocationInventorySearchFragment warehouseLocationInventorySearchFragment = new
		        WarehouseLocationInventorySearchFragment();
        FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();

        Bundle args = new Bundle();
        args.putString("api", api);
	    warehouseLocationInventorySearchFragment.setArguments(args);
        fragmentTransaction.replace(R.id.frame_content, warehouseLocationInventorySearchFragment);
