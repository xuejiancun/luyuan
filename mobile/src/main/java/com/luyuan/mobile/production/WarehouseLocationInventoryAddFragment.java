...
public class WarehouseLocationInventoryAddFragment extends Fragment {
...
//	    ((Button) view.findViewById(R.id.button_whbin)).setClickable(false);
        ((Button) view.findViewById(R.id.button_product)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View viewContent) {
	            ...
	            data.putString("wbID", ((TextView) view.findViewById(R.id.textview_wbid)).getText()
			            .toString().trim());
	            data.putString("wbIDDetail", ((TextView) view.findViewById(R.id
			            .textview_wbiddetail)).getText()
			            .toString().trim());
	            data.putString("Qty", ((TextView) view.findViewById(R.id.textview_product_qty)).getText()
			            .toString().trim());
	            data.putString("ProductCode", ((TextView) view.findViewById(R.id
			            .textview_product_code)).getText()
			            .toString().trim());
	            data.putString("wbName", ((TextView) view.findViewById(R.id.textview_wbname)).getText()
			            .toString().trim());

	            data.putString("SpecType",((TextView) view.findViewById(R.id.textview_product_spec))
			            .getText()
			            .toString().trim());
	            data.putString("PrefixName",((TextView) view.findViewById(R.id
			            .textview_product_name))
			            .getText()
			            .toString().trim());
	    ...
	    ((Button) view.findViewById(R.id.button_whbin)).setOnClickListener(new View.OnClickListener() {
		    @Override
		    public void onClick(View viewContent) {
			    ...
			    WarehouseGetBinFragment warehouseGetBinFragment  = new
					    WarehouseGetBinFragment();
			    FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
			    Bundle args = new Bundle();
			    Bundle data = new Bundle();
			    data.putString("wbID", ((TextView) view.findViewById(R.id.textview_wbid)).getText()
			    ...
			    data.putString("SpecType",((TextView) view.findViewById(R.id.textview_product_spec))
					    ...
					    .toString().trim());
			    data.putString("PrefixName", ((TextView) view.findViewById(R.id
					    .textview_product_name)).getText()
					    .toString().trim());
	;
			    args.putBundle("data", data);
			    warehouseGetBinFragment.setArguments(args);

			    fragmentTransaction.replace(R.id.frame_content,warehouseGetBinFragment);
			    fragmentTransaction.addToBackStack(null);
			    fragmentTransaction.commit();
		    }
	    });
